...
class _PatiVetPageState extends State<PatiVetPage> {
  ...
  List<Map<String, dynamic>> get _filteredClinics {
    ...
    return _clinics.where((clinic) {
      final cityMatch = clinic['city'] == _city;
      final districtMatch =
          _district == 'Tum ilceler' || clinic['district'] == _district;
      final text = [
        clinic['name'],
        clinic['city'],
        clinic['district'],
      ...
      return cityMatch && districtMatch && (query.isEmpty || text.contains(query));
    }).toList();
  }
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            _VetDropdown(
              value: _district,
              options: ['Tum ilceler', ..._districts],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Sehir bazli veteriner kesfi, yorum ve puanlama altyapisi.',
                  style: TextStyle(
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  clinic['name'] as String? ?? 'Veteriner klinigi',
                  maxLines: 1,
          ...
          Text(
            '${clinic['district']} / ${clinic['city']} - $reviewCount yorum',
            style: const TextStyle(
          ...
          const Text(
            'Puanlama ve yorum altyapisi hazir; dogrulanmis listeyle acilacak.',
            maxLines: 2,
            overflow: TextOverflow.ellipsis,
            style: TextStyle(
...
class _PatiVetEmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Text(
        'Bu bolge icin dogrulanmis klinik listesi henuz hazir degil.',
        style: TextStyle(
          color: Color(0xFF475569),
